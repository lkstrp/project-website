...
<section id="implementations" class="container py-24 sm:py-32" bind:this={sectionElement}>
  <div>
    ...
    <div class="relative py-8 overflow-x-hidden overflow-y-visible" bind:this={carouselElement}>
      ...
      <div class="carousel-container py-4" style="transform: translateX(-{carouselIndex * (100 / visibleCount)}%); transition: {isTransitioning ? 'transform 0.5s ease-in-out' : 'none'}">
        ...
        >
          <Card
            class="h-full bg-muted/50 dark:bg-card border border-border/50 shadow-lg shadow-black/10 dark:shadow-white/10 hover:shadow-xl hover:shadow-black/20 dark:hover:shadow-white/20 hover:scale-105 transition-all duration-300 rounded-2xl relative overflow-hidden group cursor-pointer mx-3"
          >
